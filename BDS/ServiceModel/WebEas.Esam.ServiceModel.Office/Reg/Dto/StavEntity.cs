...
namespace WebEas.Esam.ServiceModel.Office.Reg.Dto
{
    ...
    [Api("Reg")]
    [DataContract]
    public class CreateStavovyPriestor : StavovyPriestorDto
    {
    }
    ...
    [Api("Reg")]
    [DataContract]
    public class UpdateStavovyPriestor : StavovyPriestorDto
    {
    ...
    // List
    [WebEasRequiresAnyRole(WebEas.ServiceModel.Office.Egov.Reg.Roles.RegMember)]
    ...
    [Api("Reg")]
    [DataContract]
    public class CreateStavEntity : StavEntityDto
    {
    }
    ...
    [Api("Reg")]
    [DataContract]
    public class UpdateStavEntity : StavEntityDto
    {
        [ServiceStack.DataAnnotations.PrimaryKey]
        [DataMember(IsRequired = true)]
        public int C_StavEntity_Id { get; set; }
