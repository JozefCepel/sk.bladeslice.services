...
namespace WebEas.Esam.ServiceModel.Office.Rzp.Dto
{
    ...
    [Route("/CreateRzp", "POST")]
    [Api("Rzp")]
    [DataContract]
    public class CreateRzp : RzpDto { }
    ...
    // Delete
    [WebEasRequiresAnyRole(RolesDefinition.Rzp.Roles.RzpMember)]
    [Route("/DeleteRzp", "DELETE")]
    [Api("Rzp")]
    [DataContract]
    public class DeleteRzp
    {
        [DataMember(IsRequired = true)]
        public long D_Rzp_Id { get; set; }
    }
    ...
    #region DTO
    [DataContract]
    public class RzpDto : BaseDto<Types.Rzp>
    {
        [DataMember]
        ...
        protected override void BindToEntity(Types.Rzp data)
        {
            data.Nazov = Nazov;
            data.Popis = Popis;
            data.Datum = Datum;
