...
{
    [Schema("bds")]
    [Alias("fnStsFifo (@DatTo, @ShowLocation, @ShowSN, @ShowSarza, @ShowSklCena)")]
    [DataContract]
    public class STS_FIFOFunction: IBeforeGetList
    {
        [DataMember]
        [PrimaryKey]
        [Ignore]
        ...
        [PfeCombo(typeof(V_SKL_1View), ComboIdColumn = nameof(V_SKL_1View.K_SKL_0), ComboDisplayColumn = nameof(V_SKL_1View.SKL))]
