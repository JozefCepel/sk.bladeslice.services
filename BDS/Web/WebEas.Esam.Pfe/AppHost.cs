...
namespace WebEas.Esam.Pfe
{
    ...
    public class AppHost : EsamAppHostBase
    {
        ...
        public override IKernel AddNinjectBinding(IKernel kernel)
        {
            ...
            kernel.Bind<IWebEasServiceInterface>().To<WebEas.Esam.ServiceInterface.Office.Dms.ServiceInterface>();
            ...
            kernel.Bind<IDmsRepository>().To<DmsRepository>().InRequestScope().WithPropertyValue("StsThumbPrint", this.GetThumbprint("StsThumbprint"));
