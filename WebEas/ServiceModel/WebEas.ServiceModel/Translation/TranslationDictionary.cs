...
namespace WebEas.ServiceModel
{
    ...
    {
        public static List<string> AcceptableLanguages => new List<string> { "cs", "hu", "pl", "de", "en", "uk", "rom", "rue" };
        ...
        [Ignore]
        [DataMember]
        [PfeColumn(Text = "Globálny záznam", Editable = false, ReadOnly = true)]
        ...
        [DataMember]
        [PfeColumn(Text = "Poznámka", Hidden = true, Editable = false, Xtype = PfeXType.Textarea)]
        [StringLength(255)]
