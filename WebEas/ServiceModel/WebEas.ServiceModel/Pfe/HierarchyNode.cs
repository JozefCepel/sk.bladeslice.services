...
namespace WebEas.ServiceModel
{
    ...
    public class HierarchyNode : ICloneable
    {
        ...
        [DataMember(Name = "iconCls", EmitDefaultValue = false, IsRequired = false)]
        ...
        public static bool HasRolePrivileges(NodeAction act, UserNodeRight nodeRight)
        {
            ...
            var actionRight = act.ActionType.GetType().GetField(act.ActionType.ToString()).FirstAttribute<PfeRightAttribute>().Right;

            if(actionRight <= nodeRight.Pravo)
                return true;

            return false;
        }

        //public static bool HasRolePrivileges(NodeAction act)
        //{
        //    if()
        ...
        /// <returns></returns>
        public HierarchyNode AddChildren(List<HierarchyNode> children)
        {
