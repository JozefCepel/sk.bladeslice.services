...
namespace WebEas
{
    ...
    public class WebEasRequiredRoleAttribute : WebEasAuthenticateAttribute
    {
        /// <summary>
        ...
        public WebEasRequiredRoleAttribute(ApplyTo applyTo, params string[] roles)
        {
        ...
        /// </summary>
        /// <param name="roles">The roles.</param>
        public WebEasRequiredRoleAttribute(params string[] roles) : this(ApplyTo.All, roles)
        {
        }
        ...
        /// <returns></returns>
        public bool HasAllRoles(IWebEasSession session)
        {
            if (session == null)
            {
                return false;
