...
{ 
    ...
    /// Edm proxy
    /// </summary>
    public class EdmProxy : ProxyBase, IDisposable
    {
        private const string ServiceUrl = "https://lbsoa.intra.dcom.sk/soa/egov/edm/1.0/edm";        
        
        private Egov.EdmService.IEdmServiceChannel proxy;
        
        /// <summary>
        /// Initializes a new instance of the <see cref="EdmProxy" /> class.
        /// </summary>
        public EdmProxy(string stsThumbprint) : base(stsThumbprint)
        {
            this.proxy = WebEas.Core.Sts.SecurityTokenServiceHelper.CreateChannelProxy<Egov.EdmService.IEdmServiceChannel>(ServiceUrl, stsThumbprint);
        }
