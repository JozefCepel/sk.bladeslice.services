...
{ 
    ...
    /// Nas proxy
    /// </summary>
    public class NasProxy : ProxyBase, IDisposable
    {
        private const string ServiceUrl = "https://lbsoa.intra.dcom.sk/soa/egov/nas/1.0/nas";
        
        private Egov.NasService.INasServiceChannel proxy;
        
        /// <summary>
        /// Initializes a new instance of the <see cref="NasProxy" /> class.
        /// </summary>
        public NasProxy(string stsThumbprint) : base(stsThumbprint)
        {
            this.proxy = WebEas.Core.Sts.SecurityTokenServiceHelper.CreateChannelProxy<Egov.NasService.INasServiceChannel>(ServiceUrl, stsThumbprint);
        }
        ...
        public void SaveToEvidence(long dPodanieId)
        {
            ...
            catch (FaultException<Egov.NasService.dcomFault> ex)
            {
