...
namespace WebEas.Services.Esb.Egov
{
    ...
    /// Soc proxy
    /// </summary>
    public class SocProxy : ProxyBase, IDisposable
    {
        private const string ServiceUrl = "https://lbsoa.intra.dcom.sk/soa/egov/soc/1.0/soc";
        
        private Egov.SocService.ISocServiceChannel proxy;
                
        /// <summary>
        /// Initializes a new instance of the <see cref="ObsProxy" /> class.
        /// </summary>
        public SocProxy(string stsThumbprint) : base(stsThumbprint)
        {
            this.proxy = WebEas.Core.Sts.SecurityTokenServiceHelper.CreateChannelProxy<Egov.SocService.ISocServiceChannel>(ServiceUrl, stsThumbprint);
        }
        ...
        public void SaveToEvidence(long dPodanieId)
        {
            ...
            catch (FaultException<Egov.SocService.dcomFault> ex)
            {
