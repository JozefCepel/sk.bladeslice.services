...
namespace WebEas.Services.Esb.Egov
{
    ...
    /// Obs proxy
    /// </summary>
    public class ObsProxy : ProxyBase, IDisposable
    {
        private const string ServiceUrl = "https://lbsoa.intra.dcom.sk/soa/egov/obs/1.0/obs";
        
        private Egov.ObsService.IObsServiceChannel proxy;
                
        /// <summary>
        /// Initializes a new instance of the <see cref="ObsProxy" /> class.
        /// </summary>
        public ObsProxy(string stsThumbprint) : base(stsThumbprint)
        {
            this.proxy = WebEas.Core.Sts.SecurityTokenServiceHelper.CreateChannelProxy<Egov.ObsService.IObsServiceChannel>(ServiceUrl, stsThumbprint);
        }
        ...
        public void SaveToEvidence(long dPodanieId)
        {
            ...
            catch (FaultException<Egov.ObsService.dcomFault> ex)
            {
