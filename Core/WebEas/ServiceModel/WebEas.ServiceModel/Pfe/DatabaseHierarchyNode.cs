...
namespace WebEas.ServiceModel
{
    ...
    {
        public DatabaseHierarchyNode(string kod, string nazov, RenderDatabaseNodeDelegate renderMethod, Filter additionalFilter = null, string typ = HierarchyNodeType.Unknown, PfeSelection selectionMode = PfeSelection.Single)
        {
            this.Kod = kod;
            this.Nazov = nazov;
            this.Typ = typ;
    ...
    public class DatabaseHierarchyNode : HierarchyNode, ICloneable
    {
        ...
        public DatabaseHierarchyNode(string kod, string nazov, RenderDatabaseNodeDelegate renderMethod, Type modelType = null, Filter additionalFilter = null, string typ = HierarchyNodeType.Unknown, PfeSelection selectionMode = PfeSelection.Single)
        {
            this.Kod = kod;
            this.Nazov = nazov;
            this.Typ = typ;
        ...
        /// <returns></returns>
        public override object Render(HashSet<string> roles, List<string> itemsToExclude)
        {
