...
namespace WebEas.ServiceModel
{
    ...
    public class PfeFilter : IEquatable<PfeFilter>
    {
        ...
        public PfeFilter(PfeFilterUrl urlFilter)
        {
            ...
            this.ComparisonOperator = resString[0];
            this.LogicOperator = resString[1];
            this.Field = resString[2];
            this.LeftBrace = resString[3] == "1";
            this.RightBrace = resString[4] == "1";
            this.OnlyIdentical = resString[5] == "1";
            this.Value = urlFilter.Value;
            this.Today = (urlFilter.Value == "TODAY");
        ...
        public bool Equals(PfeFilter other)
        {
            ...
            return Equals(this.Field, other.Field) &&
                   ...
                   this.LeftBorderBrace == other.LeftBorderBrace &&
                   this.RightBorderBrace == other.RightBorderBrace &&
                   this.UseCollation == other.UseCollation &&
                   this.LeftOuterBrace == other.LeftOuterBrace &&
                   this.RightOuterBrace == other.RightOuterBrace;
        }
        ...
        {
            return this.Equals(obj as PfeFilter);
        }
