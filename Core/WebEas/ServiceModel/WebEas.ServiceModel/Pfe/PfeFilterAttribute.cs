...
namespace WebEas.ServiceModel
{
    ...
    public class PfeFilterAttribute : Attribute, IEquatable<PfeFilterAttribute>
    {
        ...
        public PfeFilterAttribute(string field, string comparisonOperator, string value, bool onlyIdentical, string logicOperator, byte leftBrace, byte rightBrace, PfeDataType type)
        {
            this.Field = field;
        ...
        /// <summary>
        /// Povolenie lavej zatvorky
        /// </summary>
        [DataMember(Name = "lbr")]
        public byte LeftBrace { get; set; }

        /// <summary>
        /// Povolenie pravej zatvorky
        /// </summary>
        [DataMember(Name = "rbr")]
