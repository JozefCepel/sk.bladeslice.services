...
namespace WebEas.ServiceModel
{
    public static class Validator
    {
        ...
        public static void Validate<T>(T data, Type descriptionType = null) where T : class
        {
            if (data == null)
            {
                return;
            ...
            foreach (PropertyInfo prop in data.GetType().GetProperties())
            {
                ...
                if (prop.HasAttribute<ServiceStack.DataAnnotations.RequiredAttribute>())
                {
                ...
                if (prop.HasAttribute<ServiceStack.DataAnnotations.RangeAttribute>())
                {
                    ServiceStack.DataAnnotations.RangeAttribute rangeAttribute = prop.FirstAttribute<ServiceStack.DataAnnotations.RangeAttribute>();
                ...
                if (prop.HasAttribute<ServiceStack.DataAnnotations.StringLengthAttribute>())
                {
                    ServiceStack.DataAnnotations.StringLengthAttribute maxLengthAttribute = prop.FirstAttribute<ServiceStack.DataAnnotations.StringLengthAttribute>();
            ...
            if (data is IValidate)
            {
                ((IValidate)data).Validate();
            }
        }
    }
}