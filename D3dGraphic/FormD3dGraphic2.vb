    ...
    Public Function SimulateValec(ByVal DesiredValec As Coord_bod, ByRef sims As List(Of D3DReturn), ByVal pocKs As Integer, maxSim As Integer) As Boolean
        ...
        If iCount > 0 Then
            ...
            For i = 1 To colMs.Count
                ...
                Dim simulacia As D3DReturn = New D3DReturn(s.SN, s.Sarza, s.Location, i, D3dOperation.D3dOperation_SimValec)
                sims.Add(simulacia)
                ...
                '    ofs = 0
                '    simulacia.Valec.Add(New ReturnValec(New CoordinatesValec(coord.d2 + ofs, coord.D1 - ofs, coord.L1 + ofs, coord.L2 - ofs), ReturnValec.D3dType.D3dType_Olive))
                'Next
