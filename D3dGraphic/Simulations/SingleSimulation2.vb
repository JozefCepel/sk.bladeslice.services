...
Friend Class SingleSimulation2
    ' The Direct3D device.
    ...
    Friend Event BeforeMaxSimulation(ByRef SingleSim As SingleSimulation2)
    Friend Event AfterMaxSimulation(ByRef SingleSim As SingleSimulation2)

    Friend Event CloseSimulation(ByRef SingleSim As SingleSimulation2)
    Friend Event SelectedSimulation(ByRef SingleSim As SingleSimulation2)
